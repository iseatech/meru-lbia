...
export default function Customs6To20() {
  ...
  if (!isAuthenticated) {
    return (
      <div className="service-detail-page">
        <SEO title="Customs Compliance - 6-20 HS Codes - Meru Express" description="Comprehensive compliance analysis for 6 to 20 HS codes." canonical="/services/customs/6-20" />
        <BackButton />
        <h1>Customs Compliance &mdash; 6&ndash;20 HS Codes</h1>
  ...
  return (
    <div className="service-detail-page">
      ...
      <p className="service-detail-desc">
        Add 6 to 20 HS codes for comprehensive duty rate analysis, tariff classification, and compliance review.
      </p>
      <div className="intake-form-wrap">
        <div className="intake-header">
          <h2 data-testid="text-form-title">6&ndash;20 HS Codes</h2>
          <span className="intake-price" data-testid="text-form-price">$129</span>
        </div>
        ...
        <form onSubmit={handleSubmit} className="intake-form" noValidate>
          <HsLineItems max={20} items={items} onChange={setItems} />
          ...
          <button type="submit" className="btn-primary intake-submit" disabled={!canSubmit} data-testid="button-submit-request">
            {submitting ? "Submitting..." : "Submit Request \u2014 $129"}
          </button>
        </form>
      </div>
    </div>
