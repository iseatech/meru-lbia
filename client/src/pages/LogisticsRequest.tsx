...
export default function LogisticsRequest() {
  ...
  if (isLoading) {
    return <div className="service-detail-page logistics-request-page"><BackButton /><div className="intake-form-wrap"><div className="intake-loading">Loading...</div></div></div>;
  }

  if (!isAuthenticated) {
    return (
      <div className="service-detail-page logistics-request-page">
        ...
        <div className="logistics-request-layout">
          ...
          <aside className="logistics-request-sidecard">
            <h3>What happens next</h3>
            <ul className="sales-bullets">
              <li>Request is reviewed against corridor and cargo context</li>
              <li>Trade, regulatory, and risk signals are consolidated</li>
              <li>Verified brief is delivered with integrity controls</li>
            </ul>
          </aside>
        </div>
      </div>
      ...
      <div className="service-detail-page logistics-request-page">
        ...
        <div className="logistics-request-layout">
          ...
          <aside className="logistics-request-sidecard">
            ...
            <ul className="sales-bullets">
              <li>Track report status from your account dashboard</li>
              <li>Download and share verified output securely</li>
              <li>Use the brief for client and operations alignment</li>
            </ul>
          </aside>
        </div>
      </div>
  ...
  return (
    <div className="service-detail-page logistics-request-page">
      ...
      <div className="logistics-request-layout">
        ...
        <aside className="logistics-request-sidecard" data-testid="logistics-request-sidecard">
          <h3>Request quality checklist</h3>
          <ul className="sales-bullets">
            <li>Include exact origin and destination context</li>
            <li>Add cargo nature and mode details clearly</li>
            <li>Describe product profile for better recommendations</li>
          </ul>
          <div className="mkt-media-placeholder">Placeholder Diagram 1200x700</div>
        </aside>
      </div>
    </div>
  );
